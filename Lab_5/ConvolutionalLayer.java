 ...
 * drawing a 1:1 or convolutional network layer.
 */
public class ConvolutionalLayer extends LayeredNetwork {
    public ConvolutionalLayer(Network subNetwork) {
        super(subNetwork);
    }
    ...
    public void createLayer(int numNodes, Canvas canvas, double x) {
            ...
            for (int i = 0; i<numNodes; i++){
                nestedLayer.add(new LinkedNode(pointA.add(0, incrementY*i), Arrays.asList(subNetwork.getNodes().get(i))));
            }
